...
-- Verificar quais brinquedos nao tem itens em estoque.
...
-- Alterar a quantidade em estoque do faqueiro para 10 pecas.
UPDATE produto
SET qtde_estoque = 10
...
-- Consultar nome e desconto de 25% no preco dos produtos que custam menos de R$50,00
select nome, valor_unitario-(valor_unitario*0.25) as desconto
from produto
where valor_unitario < 5000

-- Consultar nome e aumento de 10% no preco dos produtos que custam mais de R$100,00
